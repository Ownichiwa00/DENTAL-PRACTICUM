...
<?php $__env->startSection('title', 'Forgot Password - ToothTalk Dental Clinic'); ?>
...
<div class="patient-login-container">
    <div class="login-container">
        <div class="login-section">
            ...
            <form method="POST" action="<?php echo e(route('patient.password.request')); ?>" class="login-form">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label for="email">Email Address</label>
                    <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="back-login">
                    <a href="<?php echo e(route('patient.login')); ?>"><i class="fas fa-arrow-left"></i> Back to Login</a>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\GINO\Desktop\TOOTHTALK_FIXED\resources\views/patient/forgot-password.blade.php ENDPATH**/ ?>