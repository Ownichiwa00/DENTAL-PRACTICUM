...
<div class="patient-login-container">
    <div class="login-container">
        <div class="login-section">
            ...
            <form method="POST" action="{{ route('patient.login.submit') }}" class="login-form">
                @csrf

                <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" name="username" id="username" value="{{ old('username') }}" placeholder="Enter your username" required>
                    @error('username')
                ...
                <div class="forgot-link">
                    <a href="{{ route('patient.password.request') }}">Forgot Password?</a>
                </div>
                ...
                <div class="register-link">
                    <p>New patient? <a href="{{ route('patient.register') }}">Register here</a></p>
                </div>
            </form>
        </div>
